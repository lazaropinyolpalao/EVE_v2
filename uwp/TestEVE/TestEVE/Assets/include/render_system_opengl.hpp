...
class RenderSystemWindows : public RenderSystem {
public:
  RenderSystemWindows(int window_w, int window_h);
  ~RenderSystemWindows();
...
private:
	...
	*/
	...
	std::unique_ptr<FrameBufferToTexture> postprocess_framebuffer_;
