...
void DX::DeviceResources::CreateDeviceResources() 
{
	...
	HRESULT hr = D3D11CreateDevice(
		...
		&m_d3d11Device,					// Devuelve el dispositivo Direct3D creado.
		&m_d3dFeatureLevel,			// Devuelve el nivel de funcionalidad del dispositivo creado.
		&m_d3d11DeviceContext					// Devuelve el contexto inmediato del dispositivo.
		);
	...
	DX::ThrowIfFailed(
		m_d3d11Device.As(&m_d3dDevice)
		);

	DX::ThrowIfFailed(
		m_d3d11DeviceContext.As(&m_d3dContext)
		);
